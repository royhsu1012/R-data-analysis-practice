...
for (i in 1:(length(date1)-v)) {
  ...
  CT3.tab <- df_monthly %>% ###
    ...
    do(ols.model = lm(data = ., formula = E.ReturnAdjGeneric ~ 
                        E.M.VW + SMB + HML + CT3)) %>% ###
    mutate(CT3.monthly = as.numeric(coef(ols.model)[5])) %>%
...
for (i in 1:(length(date1)-v)) {
  ...
  TC1.tab <- df_monthly %>% 
    ...
    group_by(SecurityId) %>% 
    filter(n() >= w) %>%
    do(ols.model = lm(data = ., formula = E.ReturnAdjGeneric ~ E.M.VW + SMB + HML + TC1)) %>% 
    mutate(TC1.monthly = as.numeric(coef(ols.model)[5])) %>%
...
for (i in 1:(length(date1)-v)) {
  ...
  TC2.tab <- df_monthly %>% 
    ...
    group_by(SecurityId) %>% 
    filter(n() >= w) %>%
    do(ols.model = lm(data = ., formula = E.ReturnAdjGeneric ~ E.M.VW + SMB + HML + TC2)) %>% 
    mutate(TC2.monthly = as.numeric(coef(ols.model)[5])) %>%
...
for (i in 1:(length(date1)-v)) {
  ...
  TC3.tab <- df_monthly %>% 
    ...
    do(ols.model = lm(data = ., formula = E.ReturnAdjGeneric ~ 
                        E.M.VW + SMB + HML + TC3)) %>% 
    mutate(TC3.monthly = as.numeric(coef(ols.model)[5])) %>%
...
for (i in 1:(length(date1)-v)) {
  ...
  UT1.tab <- df_monthly %>% 
    ...
    do(ols.model = lm(data = ., formula = E.ReturnAdjGeneric ~ 
                        E.M.VW + SMB + HML + UT1)) %>% 
    mutate(UT1.monthly = as.numeric(coef(ols.model)[5])) %>%
...
for (i in 1:(length(date1)-v)) {
  ...
  UT2.tab <- df_monthly %>% 
    ...
    do(ols.model = lm(data = ., formula = E.ReturnAdjGeneric ~ 
                        E.M.VW + SMB + HML + UT2)) %>% 
    mutate(UT2.monthly = as.numeric(coef(ols.model)[5])) %>%
...
for (i in 1:(length(date1)-v)) {
  ...
  UT3.tab <- df_monthly %>% 
    ...
    do(ols.model = lm(data = ., formula = E.ReturnAdjGeneric ~ 
                        E.M.VW + SMB + HML + UT3)) %>% 
    mutate(UT3.monthly = as.numeric(coef(ols.model)[5])) %>%
...
for (i in 1:(length(date1)-v)) {
  ...
  TU1.tab <- df_monthly %>% 
    ...
    do(ols.model = lm(data = ., formula = E.ReturnAdjGeneric ~ 
                        E.M.VW + SMB + HML + TU1)) %>% 
    mutate(TU1.monthly = as.numeric(coef(ols.model)[5])) %>%
...
for (i in 1:(length(date1)-v)) {
  ...
  TU2.tab <- df_monthly %>% 
    ...
    do(ols.model = lm(data = ., formula = E.ReturnAdjGeneric ~ 
                        E.M.VW + SMB + HML + TU2)) %>% 
    mutate(TU2.monthly = as.numeric(coef(ols.model)[5])) %>%
...
for (i in 1:(length(date1)-v)) {
  ...
  TU3.tab <- df_monthly %>% 
    ...
    do(ols.model = lm(data = ., formula = E.ReturnAdjGeneric ~ 
                        E.M.VW + SMB + HML + TU3)) %>% 
    mutate(TU3.monthly = as.numeric(coef(ols.model)[5])) %>%
...
for (i in 1:(length(date1)-v)) {
  ...
  CU1.tab <- df_monthly %>% 
    ...
    do(ols.model = lm(data = ., formula = E.ReturnAdjGeneric ~ 
                        E.M.VW + SMB + HML + CU1)) %>% 
    mutate(CU1.monthly = as.numeric(coef(ols.model)[5])) %>%
...
for (i in 1:(length(date1)-v)) {
  ...
  CU2.tab <- df_monthly %>% 
    ...
    do(ols.model = lm(data = ., formula = E.ReturnAdjGeneric ~ 
                        E.M.VW + SMB + HML + CU2)) %>% 
    mutate(CU2.monthly = as.numeric(coef(ols.model)[5])) %>%
...
for (i in 1:(length(date1)-v)) {
  ...
  CU3.tab <- df_monthly %>% 
    ...
    do(ols.model = lm(data = ., formula = E.ReturnAdjGeneric ~ 
                        E.M.VW + SMB + HML + CU3)) %>% 
    mutate(CU3.monthly = as.numeric(coef(ols.model)[5])) %>%
...
for (i in 1:(length(date1)-v)) {
  ...
  UC1.tab <- df_monthly %>% 
    ...
    do(ols.model = lm(data = ., formula = E.ReturnAdjGeneric ~ 
                        E.M.VW + SMB + HML + UC1)) %>% 
    mutate(UC1.monthly = as.numeric(coef(ols.model)[5])) %>%
...
for (i in 1:(length(date1)-v)) {
  ...
  UC2.tab <- df_monthly %>% 
    ...
    do(ols.model = lm(data = ., formula = E.ReturnAdjGeneric ~ 
                        E.M.VW + SMB + HML + UC2)) %>% 
    mutate(UC2.monthly = as.numeric(coef(ols.model)[5])) %>%
...
for (i in 1:(length(date1)-v)) {
  ...
  UC3.tab <- df_monthly %>% 
    ...
    do(ols.model = lm(data = ., formula = E.ReturnAdjGeneric ~ 
                        E.M.VW + SMB + HML + UC3)) %>% 
    mutate(UC3.monthly = as.numeric(coef(ols.model)[5])) %>%
